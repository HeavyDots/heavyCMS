    ...
    public function up()
    {
        $this->execute("
            ...
            CREATE TABLE `blog_post` (
              ...
              CONSTRAINT `blog_post_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `user` (`id`),
              CONSTRAINT `blog_post_ibfk_2` FOREIGN KEY (`updated_by`) REFERENCES `user` (`id`)
            ...
            CREATE TABLE `blog_post_lang` (
              ...
              KEY `created_by` (`created_by`),
              KEY `updated_by` (`updated_by`),
              CONSTRAINT `blog_post_lang_ibfk_1` FOREIGN KEY (`blog_post_id`) REFERENCES `blog_post` (`id`),
